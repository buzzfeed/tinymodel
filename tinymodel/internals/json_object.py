...
def __field_to_json(tinymodel, this_value, raw=False, custom_translators={}):
    """
...
def to_json(tinymodel, return_dict=False, return_raw=False):
    ...
    for field in tinymodel.FIELDS:
        ...
        json_fields.update({json_field_title: __field_to_json(tinymodel, this_value=field.value, raw=return_raw, custom_translators=field.field_def.custom_translators)})
